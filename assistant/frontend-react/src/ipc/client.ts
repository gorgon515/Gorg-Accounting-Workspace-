...
export const helios = {
  ...
  sidecar: {
    ...
    securityStatus: (): Promise<any> => call((b) => b.sidecar.securityStatus()),
    securityHealth: (): Promise<any> => call((b) => b.sidecar.securityHealth()),
    vaultInitialize: (pw: string): Promise<any> => call((b) => b.sidecar.vaultInitialize(pw)),
    vaultUnlock: (pw: string): Promise<any> => call((b) => b.sidecar.vaultUnlock(pw)),
    vaultLock: (): Promise<any> => call((b) => b.sidecar.vaultLock()),
    vaultSecrets: (): Promise<any> => call((b) => b.sidecar.vaultSecrets()),
    vaultSetSecret: (p: any): Promise<any> => call((b) => b.sidecar.vaultSetSecret(p)),
    vaultGetSecret: (ref: string): Promise<any> => call((b) => b.sidecar.vaultGetSecret(ref)),
    vaultRotateSecret: (p: any): Promise<any> => call((b) => b.sidecar.vaultRotateSecret(p)),
    vaultDeleteSecret: (ref: string): Promise<any> => call((b) => b.sidecar.vaultDeleteSecret(ref)),
    vaultRotateMaster: (p: any): Promise<any> => call((b) => b.sidecar.vaultRotateMaster(p)),
    vaultAccessLog: (limit?: number): Promise<any> => call((b) => b.sidecar.vaultAccessLog(limit)),
    secMemoryPut: (p: any): Promise<any> => call((b) => b.sidecar.secMemoryPut(p)),
    secMemoryGet: (key: string): Promise<any> => call((b) => b.sidecar.secMemoryGet(key)),
    secDocumentPut: (p: any): Promise<any> => call((b) => b.sidecar.secDocumentPut(p)),
    secDocumentGet: (id: string): Promise<any> => call((b) => b.sidecar.secDocumentGet(id)),
    complianceEvents: (q?: string): Promise<any> => call((b) => b.sidecar.complianceEvents(q)),
    complianceRecord: (p: any): Promise<any> => call((b) => b.sidecar.complianceRecord(p)),
    complianceVerify: (): Promise<any> => call((b) => b.sidecar.complianceVerify()),
    complianceStats: (): Promise<any> => call((b) => b.sidecar.complianceStats()),
    permissionMatrix: (): Promise<any> => call((b) => b.sidecar.permissionMatrix()),
    permissionForAgent: (agent: string): Promise<any> => call((b) => b.sidecar.permissionForAgent(agent)),
    integrityLedger: (): Promise<any> => call((b) => b.sidecar.integrityLedger()),
    integrityAudit: (): Promise<any> => call((b) => b.sidecar.integrityAudit()),
    backupCreate: (p: any): Promise<any> => call((b) => b.sidecar.backupCreate(p)),
    backupList: (limit?: number): Promise<any> => call((b) => b.sidecar.backupList(limit)),
    backupStats: (): Promise<any> => call((b) => b.sidecar.backupStats()),
    backupVerify: (id: string): Promise<any> => call((b) => b.sidecar.backupVerify(id)),
    backupRetention: (keep: number): Promise<any> => call((b) => b.sidecar.backupRetention(keep)),
    restoreValidate: (p: any): Promise<any> => call((b) => b.sidecar.restoreValidate(p)),
    restoreInspect: (p: any): Promise<any> => call((b) => b.sidecar.restoreInspect(p)),
    restoreRun: (p: any): Promise<any> => call((b) => b.sidecar.restoreRun(p)),
    recoveryPoints: (): Promise<any> => call((b) => b.sidecar.recoveryPoints()),
    recoveryPlan: (): Promise<any> => call((b) => b.sidecar.recoveryPlan()),
    recoverySimulate: (pw: string): Promise<any> => call((b) => b.sidecar.recoverySimulate(pw)),
    recoveryReport: (pw?: string): Promise<any> => call((b) => b.sidecar.recoveryReport(pw)),
    syncRegisterDevice: (name: string): Promise<any> => call((b) => b.sidecar.syncRegisterDevice(name)),
    syncDevices: (): Promise<any> => call((b) => b.sidecar.syncDevices()),
    syncPush: (p: any): Promise<any> => call((b) => b.sidecar.syncPush(p)),
    syncPull: (p: any): Promise<any> => call((b) => b.sidecar.syncPull(p)),
    syncConflicts: (): Promise<any> => call((b) => b.sidecar.syncConflicts()),
    syncAudit: (): Promise<any> => call((b) => b.sidecar.syncAudit()),
    syncStatus: (): Promise<any> => call((b) => b.sidecar.syncStatus()),
  },
